...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: absoluteUrl("/tools/java-to-typescript"), changeFrequency: "monthly", priority: 0.6 },
    { url: absoluteUrl("/tools/spring-cors-generator"), changeFrequency: "monthly", priority: 0.6 },
    { url: absoluteUrl("/tools/jwt-decoder"), changeFrequency: "monthly", priority: 0.6 },
